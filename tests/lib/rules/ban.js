...
var RuleTester8 = require('eslint').RuleTester;
var RuleTester9 = require('eslint-9').RuleTester;
...
runTests(new RuleTester8());
runTests(new RuleTester9());
